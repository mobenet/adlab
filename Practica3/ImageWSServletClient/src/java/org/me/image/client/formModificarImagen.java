        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (user == null) {
                ...
                try {
                    ...
                    //org.me.image.ImageWS_Service serv = new org.me.image.ImageWS_Service();
                    //org.me.image.ImageWS port = serv.getImageWSPort();
                    int id = Integer.parseInt(ses.getAttribute("imageId").toString()); 
                    
                    out.println("el id es "+ id);
                    Image img = searchbyId(id);

                    out.println("EL TITULO DE LA IMAGEN ES" + img.getTitle());
